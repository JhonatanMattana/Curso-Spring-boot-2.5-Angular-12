...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Valdir", "190.210.070-02", "valdir@gmail.com", encoder.encode("123"));
		tec1.addPerfis(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente(null, "Linus", "448.441.260-83", "linus@gmail.com", encoder.encode("123"));
